...
export interface RoomState {
  chatRooms: Chatroom[];
  createdRoomId: string | undefined;
}
...
export const roomSlice = createSlice({
  ...
  reducers: { 
    clearCreatedRoomId: (state) => {
      state.createdRoomId = undefined;
    },
  },
    ...
    builder
      ...
      .addCase(createRoomAsync.fulfilled, (state, action) => {
        ...
        if (action.payload.success) {
          state.createdRoomId = action.payload.id.toString();
        }
      })
...
export const { clearCreatedRoomId } = roomSlice.actions;
